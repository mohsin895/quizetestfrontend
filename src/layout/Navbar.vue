...
<template>
  <div class="bg-black page-header fixed">
    <div
      class="header-body text-white flex justify-between items-center text-center"
    >
    ...
    <div class="side-bar">
      ...
      <div class="menu">
        <!-- <div class="item"> <router-link :to="{ name: 'Dashboard' }">Dashboard</router-link></div>
      -->
        <div class="item"><router-link :to="{ name: 'QuizeList' }">Quize</router-link></div>
